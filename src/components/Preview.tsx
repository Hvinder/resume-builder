    ...
    <div className="w-full">
      <div className="flex flex-col gap-2">
        {resumeDetails.personalDetails.name && (
          <div className="w-full text-4xl text-center">{resumeDetails.personalDetails.name}</div>
        )}
        {resumeDetails.personalDetails.title && (
          <div className="w-full text-2xl text-center">{resumeDetails.personalDetails.title}</div>
        )}
